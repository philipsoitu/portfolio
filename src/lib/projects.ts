...
export const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    year: "2026",
    tags: ["Zig", "libfreenect", "Raspberry Pi", "Nix"],
  ...
  },
  {
    ...
    year: "2025",
    tags: ["Ray Tracing", "Taichi", "GPU Compute"],
  ...
  },
  {
    ...
    repo_link: "github.com/philipsoitu/IntegrativeProject"
  },
  {
    ...
    cover: "/raccoons/5.webp",
    gallery: [],
    body:
      "Hackathon project at Concordia University (January 2026). Built a document AI pipeline to extract schedules from PDFs with dual parsing paths and robust error handling, then surfaced tasks in a real-time student calendar UI.",
    repo_link: "github.com/AnaisPerron/ask-ethan/",
    deployment_link: "devpost.com/software/ask-ethan"
